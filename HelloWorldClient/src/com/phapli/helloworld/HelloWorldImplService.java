 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://helloworld.phapli.com/", wsdlLocation = "http://localhost:8080/HelloWorld/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://helloworld.phapli.com/", "HelloWorldImplService");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://helloworld.phapli.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://helloworld.phapli.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
